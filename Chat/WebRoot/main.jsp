...
var sysBBS="<span style='font-size:14px; line-height:30px;'>欢迎光临学生家园聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";
...
<select name="face" class="wenbenkuang">
  ...
  <option value="娇羞的">娇羞的</option>
  <option value="温柔的" selected>温柔的</option>
...
<input name="scrollScreen" type="checkbox" class="noborder" id="scrollScreen" onClick="checkScrollScreen()" value="1" checked></td>
  ...
  <tr>
    ...
    <td align="right"><input name="button_exit" type="button" class="btn_blank" value="关闭" onClick="Exit()"></td>
    <td align="center">&nbsp;</td>
  </tr>
  <tr>
    <td height="30" align="left">&nbsp;</td>
    <td colspan="2" align="center" class="word_dark">&nbsp;学生家园聊天室  &nbsp;2015 &nbsp;河北工程大学</td>
    <td align="center">&nbsp;</td>
  </tr>
</form>
</table>
